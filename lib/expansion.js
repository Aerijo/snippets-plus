    ...
    this.subscriptions.add(
      this.buffer.onDidChange((event) => {
        if (this.isFirstBufferChange) {
          // This is necessary because even if we subscribe after
          // inserting the body, it is possible we are being called
          // in a transaction (autocomplete-plus does this) and
          // therefore the change event would be deferred until after
