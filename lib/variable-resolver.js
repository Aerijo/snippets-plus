...
class DefaultVariableResolver {
  ...
  blockCommentStart({ editor, insertionPoint }) {
    const scopes = getScopeChain(editor.scopeDescriptorForBufferPosition(insertionPoint));
    const comments = DefaultVariableResolver.scopeToCommentsMap.getPropertyValue(scopes);
...
DefaultVariableResolver.scopeToCommentsMap.addProperties("default comments", {
  ...
  ".source.js,.source.java,.source.c,.source.cpp": {
    start: "/*",
    end: "*/",
    line: "//",
  },
