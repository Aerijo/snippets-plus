...
class SnippetExpansions {
  ...
  expandSnippetsUnderCursors(parser) {
    ...
    const expansion = snippet.getExpansion(this.getContext(cursor, prefix), parser, this.markerLayer);
    ...
    expansion.insert(prefixRange, this.markerLayer);
